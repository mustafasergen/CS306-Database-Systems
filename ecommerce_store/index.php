...
<html>
<head>
    <title>MAIN PAGE for STORES</title>
...
<header class="page-header">
    <h1>Welcome to our DataBase of Store!</h1>
</header>
...
<form class="form-style-9" action="insertstore.php" method="POST" >
<ul>
<li>
    <input type="text" id="sID" name="sID" class="field-style field-full align-none" placeholder="sID" />
</li>  
<li>
...
<div align="left">
    <h1>For a delete click the image <a href="http://localhost/ecommerce_store/admin.php"><img src="resim2.png" style="width:42px;height:42px;"></a></h1>
</div>
